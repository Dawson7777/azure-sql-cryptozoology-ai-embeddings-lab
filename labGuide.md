...
1. If in part 1, you get to the **Manage deployments of your models and services** page and it is empty:
	...
	![IMAGEScreenshot2025-05-13at9.59.50AM.png](./media/Screenshot2025-05-13at9.59.50AM.png)

    Use the browser tabs and go **back to the AI Foundry Project details page** by clicking that tab.

	![IMAGEScreenshot2025-05-13at10.01.10AM.png](./media/Screenshot2025-05-13at10.01.10AM.png)

1. On the **AI Foundry Project details page**, look in the upper right corner of the page and find the **Azure Portal Tool Bar**.

	![IMAGEScreenshot2025-05-13at10.03.18AM.png](./media/Screenshot2025-05-13at10.03.18AM.png)

1. Find the **Cloud Shell icon** and click on it.

	![IMAGEScreenshot2025-05-13at10.06.01AM.png](./media/Screenshot2025-05-13at10.06.01AM.png)

1. A **Cloud Shell** window should open on the bottom of the browser.

	![IMAGEScreenshot2025-05-13at10.17.26AMcopy.png](./media/Screenshot2025-05-13at10.17.26AMcopy.png)

    then, click the **PowerShell** button.

    ![IMAGEScreenshot2025-05-13at10.17.26AM.png](./media/Screenshot2025-05-13at10.17.26AM.png)

1. In the **Getting started** model window, 

	![IMAGEScreenshot2025-05-13at10.20.57AM.png](./media/Screenshot2025-05-13at10.20.57AM.png)

	use the **Subscription dropdown** to select **Build-lodXYZ** (Where XYZ is a number unique to your environment/subscription).

    ![IMAGEScreenshot2025-05-13at10.21.16AM.png](./media/Screenshot2025-05-13at10.21.16AM.png)

1. With the **Subscription** select list set, click the **blue Apply button**.

	![IMAGEScreenshot2025-05-13at10.24.48AM.png](./media/Screenshot2025-05-13at10.24.48AM.png)

1. The Cloud Shell will connect and you will be presented with a **PowerShell command prompt**.

	![IMAGEScreenshot2025-05-13at10.27.09AM.png](./media/Screenshot2025-05-13at10.27.09AM.png)
...
1. The first step is to **create a PowerShell script** that we can use to create the 2 model deployments.
    ...
    ![IMAGEScreenshot2025-05-13at10.33.40AM.png](./media/Screenshot2025-05-13at10.33.40AM.png)

    at the command prompt.

	![IMAGEScreenshot2025-05-13at10.34.17AM.png](./media/Screenshot2025-05-13at10.34.17AM.png)
...
1. After **pressing enter/return**, you will be in the vi editor. Copy the following text:
    ...
    New-AzCognitiveServicesAccountDeployment -ResourceGroupName Build25ResourceGroup -AccountName build25ai@lab.LabInstance.Id -Name gpt-4o -Properties $propertiesG -Sku $skuG

    New-AzCognitiveServicesAccountDeployment -ResourceGroupName Build25ResourceGroup -AccountName build25ai@lab.LabInstance.Id -Name text-embedding-ada-002 -Properties $propertiesA -Sku $skuA
    ```
	...
	![IMAGEScreenshot2025-05-13at10.39.46AM.png](./media/Screenshot2025-05-13at10.39.46AM.png)
...
1. To save the file, start by typing **Shift + :** (shift key and the colon/semicolon key). That will being you to the **vi editor prompt indicated by a colon**.
	...
	![IMAGEScreenshot2025-05-13at10.44.47AM.png](./media/Screenshot2025-05-13at10.44.47AM.png)

1. At the **vi editor prompt**, type **w then q** (w key and the q key).

	![IMAGEScreenshot2025-05-13at10.46.30AM.png](./media/Screenshot2025-05-13at10.46.30AM.png)
...
1. Now, at the PowerShell prompt, type or copy and paste the following text:
	...
	![IMAGEScreenshot2025-05-13at10.49.53AM.png](./media/Screenshot2025-05-13at10.49.53AM.png)

    and then **press enter/return** to run the PowerShell script to deploy the models.

	![IMAGEScreenshot2025-05-13at10.52.12AM.png](./media/Screenshot2025-05-13at10.52.12AM.png)

1. Use the browser tabs to gp back to the **Manage deployments of your models and services** page.

	![IMAGEScreenshot2025-05-13at10.54.57AM.png](./media/Screenshot2025-05-13at10.54.57AM.png)
...
1. Back on the **Manage deployments of your models and services** page, click the **Refresh** button in the **Model deployments** section.
	...
	![IMAGEScreenshot2025-05-13at10.57.18AM.png](./media/Screenshot2025-05-13at10.57.18AM.png)

1. You should now see the 2 deployed models.

	![IMAGEScreenshot2025-05-13at10.55.24AM.png](./media/Screenshot2025-05-13at10.55.24AM.png)

## Embedding Issue {#embeddingissue}

If you run into issues **(HTTP Status 400)** when creating embeddings, follow the following steps.

1. **Copy and paste** the following code into an empty query sheet in VS Code:
...
![IMAGEA picture of the azure portal having trouble signing in](./media/Screenshot2024-10-29at6.55.36AM.png)

1. Start by closing the browser.

1. Next, **right** clicking on the time in the tray on the bottom right of the VM

    ![IMAGEA picture of right clicking on the time in the tray on the bottom right of the VM](./media/Screenshot2024-10-24at9.05.04AM.png)

1. Then, select **Adjust date and time**

    ![IMAGEA picture of selecting Adjust date and time after right clicking on the time](./media/Screenshot2024-10-24at9.05.12AM.png)

1. On the **Date & time** settings page, find the **Additional settings** section.

    ![IMAGEA picture of finding the Additional settings section on the Date & time settings page](./media/Screenshot2024-10-24at9.08.21AM.png)

1. Click the **Sync Now** button and close the settings application.

    ![IMAGEA picture of clicking the Sync Now button](./media/Screenshot2024-10-24at9.10.25AM.png)

1. Reopen the browser, and on the Pick an account page, select **User another account**

    ![IMAGEA picture of signing in again to the azure portal in the edge browser](./media/Screenshot2024-10-29at6.55.36AM.png)
...
![IMAGEA picture of the Cancel Query button in the upper right of the query editor in Visual Studio Code](./media/Screenshot2024-11-01at11.08.58AM.png)
...
![IMAGEA picture of clicking the Display menu at the top of the browser page and selecting Reconnect](./media/Screenshot2024-10-24at8.59.35AM.png)
...
![IMAGEA picture of the no networking available icon](./media/Screenshot2024-10-24at9.02.30AM.png)
